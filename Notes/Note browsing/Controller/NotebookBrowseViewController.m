...
- (void)presentNotebookPopoverAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [UIView animateWithDuration:0.25f animations:^{
        ...
        [popover presentPopoverFromRect:newCell.frame inView:self.view permittedArrowDirections:UIPopoverArrowDirectionUp animated:YES];
...
- (void)finishPresentingPopover {
    ...
    [UIView animateWithDuration:0.25f animations:^{
        self.editingNotebook.frame = [originalCell.superview convertRect:originalCell.frame toView:self.view];
    } completion:^(BOOL finished) {
